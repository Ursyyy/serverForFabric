...
module.exports = async function main(PATH_TO_DIR) {

    let res = ""
    // A wallet stores a collection of identities for use
    const wallet = await Wallets.newFileSystemWallet(PATH_TO_DIR + '../identity/user/isabella/wallet');
    ...
    try {
        ...
        let connectionProfile = yaml.safeLoad(fs.readFileSync(PATH_TO_DIR + '../gateway/connection-org2.yaml', 'utf8'));
        ...
        res = `commercial paper issued by ${paper.issuer}  : ${paper.paperNumber} was successfully transferred`
        console.log(res);
